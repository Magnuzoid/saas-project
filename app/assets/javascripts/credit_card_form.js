...
$(document).ready(function(){
  ...
  submitHandler = function(e) {
    ...
    if (Stripe) {
      ...
      show_error("Failed to lead credit card processing functionality. Please reload the page");
    }
    return false;
  ...
  // set up plan change event listener #tenant_plan is in the forms for class cc_form
